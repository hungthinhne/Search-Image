              ...
              <div className="body-sigin">
                <div className="d-flex">
                  <div className="mt-auto text-white p-3">
                    <h4>
                      Hãy là thành viên mới của OnThePitch góp phần tạo nên
                      phong trào bóng đá mạnh mẻ cho Thành Phố. Chuyên nghiệp
                      hóa về bóng đá Phủi trong khu vực.
                    </h4>
                    <div className="d-flex">
                ...
                <div className="form-sigin-right">
                  ...
                  <div className="form-right-body-order ms-2 ps-5 rounded-bottom">
                    <div className="d-flex">
                      <div className="d-block">
